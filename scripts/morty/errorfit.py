...
if chem:
    ...
    peak = [7.41,  5.96,  4.49, 3.01,  1.51,   0.0038]
    ss =   [0.81, 0.53, 0.31, 0.141, 0.0388, 1.39e-6]
elif flow_scaled:
    ...
    xs =   [21.75e-4, 21.57e-3, 21.57e-2, 21.57e-1, 21.75,  21.75e1,  21.75e2]
    peak = [15.39,    3.09,     0.29,    0.036,    0.0038, 0.000387, 3.87e-5]
    ss =   [2.48,     0.82,    0.014,   0.00076,  2.4e-5, 3.47e-6,   5.23e-7]
